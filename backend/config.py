...
TICKET_TAILOR_WEBHOOK_SIGNATURE: str = os.environ.get(
    "TICKET_TAILOR_WEBHOOK_SIGNATURE",
    "",
)
TICKET_TAILOR_PLAYER_TICKET_TYPE_ID = os.environ.get(
    "TICKET_TAILOR_PLAYER_TICKET_TYPE_ID",
    "",
)
TICKET_TAILOR_EVENT_ID = os.environ.get("TICKET_TAILOR_EVENT_ID", "")
